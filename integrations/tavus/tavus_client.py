            ...
            payload = [
                {
                    ...
                    "value": {
                        "ambient_awareness_queries": [
                            "L'utilisateur semble-t-il avoir chute ou etre tombe au sol ?",
                            "L'utilisateur semble-t-il inconscient, sans reaction ou endormi involontairement ?",
                            "L'utilisateur tient-il une partie de son corps comme s'il souffrait (blessure, douleur) ?",
                            "L'environnement presente-t-il un danger imminent (feu, fumee, eau, objet brise) ?",
                            "L'utilisateur semble-t-il confus, desoriante ou perdu dans ses pensees ?",
                            "L'utilisateur montre-t-il des signes de detresse emotionnelle intense (pleurs, agitation) ?",
                            "L'utilisateur semble-t-il chercher un medicament ou avoir oublie de le prendre ?",
                            "L'utilisateur semble-t-il seul et en manque de contact humain depuis longtemps ?",
                        ],
