...
# =====================================================================
# SYSTÈME VISUEL PREMIUM — SVG ASSETS + DESIGN SYSTEM
# =====================================================================

BADGE_VISUAL_BASE = "/static/assets/badges"

BADGE_RARITY_VISUALS = {
    "common": {
        "tier": "common",
        "label": "Argent Luna",
        "gradient": "linear-gradient(135deg, #cbd5e1, #f8fafc)",
    ...
    "legendary": {
        ...
        "border": "#fbbf24",
        "animation": "luna-legendary-shine",
    },
    "prestige": {
        "tier": "prestige",
        "label": "Prestige Luna",
        "gradient": "linear-gradient(135deg, #f43f5e, #c084fc, #fbbf24)",
        "glow": "rgba(244,63,94,0.75)",
        "border": "#fb7185",
        "animation": "luna-prestige-orbit",
    },
}

_B = BADGE_VISUAL_BASE
BADGE_VISUALS = {
    # ---- CLIENT ----
    "first_chat":          {"asset": f"{_B}/client/first_chat.svg",          "fallback": "luna-badge-dialogue",      "theme": "violet_gold",    "effect": "soft_glow"},
    "profile_complete":    {"asset": f"{_B}/client/profile_complete.svg",    "fallback": "luna-badge-identity",      "theme": "violet_gold",    "effect": "gold_edge"},
    "first_contact":       {"asset": f"{_B}/client/first_contact.svg",       "fallback": "luna-badge-connection",    "theme": "blue_gold",      "effect": "connection_glow"},
    "first_call":          {"asset": f"{_B}/client/first_call.svg",          "fallback": "luna-badge-voice",         "theme": "violet_gold",    "effect": "wave_glow"},
    "three_contacts":      {"asset": f"{_B}/client/three_contacts.svg",      "fallback": "luna-badge-constellation", "theme": "warm_gold",      "effect": "star_link"},
    "bavard":              {"asset": f"{_B}/client/bavard.svg",              "fallback": "luna-badge-conversation",  "theme": "blue_violet",    "effect": "speech_particles"},
    "conteur":             {"asset": f"{_B}/client/conteur.svg",             "fallback": "luna-badge-book",          "theme": "violet_gold",    "effect": "page_glow"},
    "mille_mots":          {"asset": f"{_B}/client/mille_mots.svg",          "fallback": "luna-badge-pen",           "theme": "gold_violet",    "effect": "gold_trail"},
    "week_streak":         {"asset": f"{_B}/client/week_streak.svg",         "fallback": "luna-badge-flame",         "theme": "violet_gold",    "effect": "flame_pulse"},
    "two_week_streak":     {"asset": f"{_B}/client/two_week_streak.svg",     "fallback": "luna-badge-double-flame",  "theme": "violet_gold",    "effect": "dual_pulse"},
    "month_streak":        {"asset": f"{_B}/client/month_streak.svg",        "fallback": "luna-badge-crown",         "theme": "legendary_gold", "effect": "gold_shine"},
    "regular":             {"asset": f"{_B}/client/regular.svg",             "fallback": "luna-badge-orbit",         "theme": "blue_violet",    "effect": "orbit"},
    "first_instruction":   {"asset": f"{_B}/client/first_instruction.svg",   "fallback": "luna-badge-scroll",        "theme": "violet_gold",    "effect": "command_glow"},
    "first_note":          {"asset": f"{_B}/client/first_note.svg",          "fallback": "luna-badge-capsule",       "theme": "soft_violet",    "effect": "memory_glow"},
    "explorateur":         {"asset": f"{_B}/client/explorateur.svg",         "fallback": "luna-badge-compass",       "theme": "violet_gold",    "effect": "needle_shine"},
    "multi_canal":         {"asset": f"{_B}/client/multi_canal.svg",         "fallback": "luna-badge-portals",       "theme": "blue_violet",    "effect": "portal_glow"},
    "family_pioneer":      {"asset": f"{_B}/client/family_pioneer.svg",      "fallback": "luna-badge-home",          "theme": "warm_gold",      "effect": "warm_halo"},
    "family_builder":      {"asset": f"{_B}/client/family_builder.svg",      "fallback": "luna-badge-network",       "theme": "blue_gold",      "effect": "node_glow"},
    "family_protector":    {"asset": f"{_B}/client/family_protector.svg",    "fallback": "luna-badge-shield",        "theme": "gold_violet",    "effect": "guardian_glow"},
    "family_communicator": {"asset": f"{_B}/client/family_communicator.svg", "fallback": "luna-badge-signal",        "theme": "blue_gold",      "effect": "signal_rays"},
    "first_visio":         {"asset": f"{_B}/client/first_visio.svg",         "fallback": "luna-badge-mirror",        "theme": "blue_violet",    "effect": "mirror_glow"},
    "level_5":             {"asset": f"{_B}/client/level_5.svg",             "fallback": "luna-badge-guardian",      "theme": "guardian_blue",  "effect": "guardian_glow"},
    "level_10":            {"asset": f"{_B}/client/level_10.svg",            "fallback": "luna-badge-star-core",     "theme": "legendary_gold", "effect": "legendary_shine"},
    "centenaire":          {"asset": f"{_B}/client/centenaire.svg",          "fallback": "luna-badge-hundred",       "theme": "legendary_gold", "effect": "gold_pulse"},
    "stability_90":        {"asset": f"{_B}/client/stability_90.svg",        "fallback": "luna-badge-anchor",        "theme": "blue_gold",      "effect": "stable_glow"},
    "first_dm":            {"asset": f"{_B}/client/first_dm.svg",            "fallback": "luna-badge-message",       "theme": "violet_gold",    "effect": "private_glow"},
    "social_butterfly":    {"asset": f"{_B}/client/social_butterfly.svg",    "fallback": "luna-badge-wings",         "theme": "epic_violet",    "effect": "wing_shimmer"},
    "popular":             {"asset": f"{_B}/client/popular.svg",             "fallback": "luna-badge-aura",          "theme": "legendary_gold", "effect": "social_orbit"},
    # prestige
    "founder_alpha":       {"asset": f"{_B}/client/founder_alpha.svg",       "fallback": "luna-badge-founder",       "theme": "prestige",       "effect": "founder_aura"},
    "pioneer_ia":          {"asset": f"{_B}/client/pioneer_ia.svg",          "fallback": "luna-badge-pioneer",       "theme": "prestige",       "effect": "prestige_orbit"},
    "protector_luna":      {"asset": f"{_B}/client/protector_luna.svg",      "fallback": "luna-badge-protector",     "theme": "prestige",       "effect": "guardian_glow"},
    "mythic_soul":         {"asset": f"{_B}/client/mythic_soul.svg",         "fallback": "luna-badge-mythic",        "theme": "prestige",       "effect": "mythic_aura"},
    "eternal_flame":       {"asset": f"{_B}/client/eternal_flame.svg",       "fallback": "luna-badge-eternal",       "theme": "prestige",       "effect": "eternal_burn"},
    "top_helper":          {"asset": f"{_B}/client/top_helper.svg",          "fallback": "luna-badge-helper",        "theme": "legendary_gold", "effect": "gold_orbit"},
    "architecte_badge":    {"asset": f"{_B}/client/architecte_badge.svg",    "fallback": "luna-badge-architect",     "theme": "prestige",       "effect": "architect_aura"},
    # ---- ADMIN ----
    "first_client":        {"asset": f"{_B}/admin/first_client.svg",         "fallback": "luna-badge-admin-seal",    "theme": "violet_gold",    "effect": "soft_glow"},
    "five_clients":        {"asset": f"{_B}/admin/five_clients.svg",         "fallback": "luna-badge-admin-team",    "theme": "blue_gold",      "effect": "node_glow"},
    "ten_clients":         {"asset": f"{_B}/admin/ten_clients.svg",          "fallback": "luna-badge-admin-crown",   "theme": "legendary_gold", "effect": "gold_shine"},
    "revenue_500":         {"asset": f"{_B}/admin/revenue_500.svg",          "fallback": "luna-badge-admin-gem",     "theme": "gold_violet",    "effect": "money_glow"},
    "revenue_2000":        {"asset": f"{_B}/admin/revenue_2000.svg",         "fallback": "luna-badge-admin-growth",  "theme": "legendary_gold", "effect": "ascending_glow"},
    "all_services_ok":     {"asset": f"{_B}/admin/all_services_ok.svg",      "fallback": "luna-badge-admin-core",    "theme": "blue_violet",    "effect": "system_pulse"},
    "client_level_10":     {"asset": f"{_B}/admin/client_level_10.svg",      "fallback": "luna-badge-admin-mentor",  "theme": "legendary_gold", "effect": "legendary_shine"},
    "zero_alerts_week":    {"asset": f"{_B}/admin/zero_alerts_week.svg",     "fallback": "luna-badge-admin-zen",     "theme": "warm_gold",      "effect": "zen_glow"},
}
